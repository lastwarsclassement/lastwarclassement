...
const ADMIN_STEPS: Step[] = [
  ...
  },
  {
    ...
    body: 'En fin de semaine, cliquez **✅ Valider la semaine**.\n\nL\'app attribue automatiquement :\n• **Top 7 → Pilotes de Train** (base semaine suivante = 0)\n• **7 suivants → VIP** (base = points conservés)\n• **Anniversaires** : joueur avec anniversaire la semaine suivante = place de Pilote réservée, mais **garde ses points** comme base (pas de reset). Priorité aux points s\'il y a plus de 7 anniversaires dans la semaine.\n\nVérifiez le récapitulatif puis cliquez **✅ Confirmer**.',
    bodyEn: 'At week end, click **✅ Validate week**.\n\nThe app automatically assigns:\n• **Top 7 → Train Pilots** (next week base = 0)\n• **Next 7 → VIP** (base = points kept)\n• **Birthdays**: player with birthday next week = reserved Pilot spot, but **keeps their points** as base (no reset). Priority goes to highest points if more than 7 birthdays fall in the same week.\n\nVerify the summary then click **✅ Confirm**.',
    pageUrl: '/dashboard',
