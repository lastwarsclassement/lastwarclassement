...
const ADMIN_STEPS: Step[] = [
  ...
  },
  {
    ...
    body: 'Deux types de semaines :\n\n**Push** — points selon paliers de score VS :\n→ ≥ 7.2M : +1 pt · ≥ 15M : +2 pts · ≥ 25M : +4 pts · < 7.2M : -3 pts\n\n**Éco** — rester proche de 7.2M sans dépasser 15M :\n→ Rang 1–10 : +3 pts · 11–20 : +2 pts · 21–30 : +1 pt · hors zone : -3 pts\n\nLe bouton **⇄ Push → Éco** (ou **⇄ Éco → Push**) indique le mode actuel et la destination.\n\n⚠️ Changer de mode en cours de semaine ne recalcule **pas** les scores déjà saisis. Chaque jour conserve le mode actif au moment de la saisie (affiché P/É dans les entêtes du tableau).',
    bodyEn: 'Two week types:\n\n**Push** — points based on VS score thresholds:\n→ ≥ 7.2M: +1 pt · ≥ 15M: +2 pts · ≥ 25M: +4 pts · < 7.2M: -3 pts\n\n**Eco** — stay close to 7.2M without exceeding 15M:\n→ Rank 1–10: +3 pts · 11–20: +2 pts · 21–30: +1 pt · out of zone: -3 pts\n\nThe **⇄ Push → Eco** (or **⇄ Eco → Push**) button shows the current mode and destination.\n\n⚠️ Switching mid-week does **not** recalculate already-entered scores. Each day keeps the mode that was active when scores were entered (shown as P/E in table headers).',
    pageUrl: '/dashboard',
  ...
  },
  {
    ...
    body: 'Chaque soir, cliquez **📊 Saisir les scores** :\n\n• **Lundi → Samedi** : score VS de chaque joueur\n  Formats acceptés : **7 200 000** · **7.2M** · **7200K**\n  Chaque bouton de jour affiche un badge **▲P** (Push) ou **●É** (Éco)\n\n• **Dimanche** : score de **Contribution d\'Alliance** de chaque joueur\n  Points calculés automatiquement :\n  → Rang 1–10 : +10 pts · 11–20 : +6 pts · 21–30 : +3 pts\n\n✓ = jour déjà saisi (modifiable). Si le mode de la semaine a changé depuis la dernière saisie, une alerte jaune prévient que le mode d\'origine sera conservé.',
    bodyEn: 'Each evening, click **📊 Enter scores**:\n\n• **Monday → Saturday**: each player\'s VS score\n  Accepted formats: **7 200 000** · **7.2M** · **7200K**\n  Each day button shows a **▲P** (Push) or **●É** (Eco) badge\n\n• **Sunday**: each player\'s **Alliance Contribution** score\n  Points auto-calculated:\n  → Rank 1–10: +10 pts · 11–20: +6 pts · 21–30: +3 pts\n\n✓ = day already entered (editable). If the week mode changed since the last entry, a yellow alert warns that the original mode will be preserved.',
    pageUrl: '/dashboard',
  ...
  {
    icon: '🎁',
    title: 'Attribuer des récompenses',
    titleEn: 'Grant Rewards',
    body: 'Cliquez **🎁 Récompenses** pour ajouter des points bonus à des joueurs.\n\n• Choisissez le nombre de points à ajouter\n• Cochez les joueurs à récompenser\n• Plusieurs récompenses cumulables sur la même semaine\n• Le compteur de récompenses existantes s\'affiche à côté de chaque joueur, et chaque récompense peut être annulée depuis le panneau\n\nLes points de récompense apparaissent dans la colonne **Récompenses** du classement.',
    bodyEn: 'Click **🎁 Rewards** to add bonus points to players.\n\n• Choose how many points to add\n• Check the players to reward\n• Multiple rewards can stack in the same week\n• Existing reward count is shown next to each player, and each reward can be canceled from the panel\n\nReward points appear in the **Rewards** column of the leaderboard.',
    pageUrl: '/dashboard',
    pageFr: 'Dashboard — 🎁 Récompenses',
    pageEn: 'Dashboard — 🎁 Rewards',
  },
  {
    icon: '✅',
    title: 'Valider la semaine',
    titleEn: 'Validate the Week',
    body: 'En fin de semaine, cliquez **✅ Valider la semaine**.\n\nL\'app attribue automatiquement, uniquement selon le classement :\n• **Top 7 → Pilotes de Train** (base semaine suivante = 0)\n• **7 suivants → VIP** (base = points conservés)\n\nLes anniversaires n\'ont plus d\'effet sur les rôles : un badge 🎂 s\'affiche simplement à côté du joueur concerné.\n\nVérifiez le récapitulatif puis cliquez **✅ Confirmer**.',
    bodyEn: 'At week end, click **✅ Validate week**.\n\nThe app automatically assigns roles based on ranking only:\n• **Top 7 → Train Pilots** (next week base = 0)\n• **Next 7 → VIP** (base = points kept)\n\nBirthdays no longer affect roles: a 🎂 badge is simply shown next to the player.\n\nVerify the summary then click **✅ Confirm**.',
    pageUrl: '/dashboard',
